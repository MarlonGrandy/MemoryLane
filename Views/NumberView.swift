...
//  This file creates a stylized capsule view designed to display reflection analytics.

import SwiftUI

// A View struct to create a custom capsule-like design to display a title and its associated value.
struct NumberView: View {
    
    // State property to hold the title text of the capsule.
    @State var title: String
    
    // A binding property that represents the integer value associated with the title.
    @Binding var titleValues: Int
    ...
    var body: some View {
        ZStack {
            ...
            // Middle layer: vertically stacked title and value text.
            VStack{
                Spacer()
